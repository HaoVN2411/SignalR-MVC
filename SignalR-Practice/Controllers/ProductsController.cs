...
namespace SignalR_Practice.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ApplicationDBContext context, IHubContext<SignalRServer> hubContext)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("ProId,ProdName,Category,UnitPrice,StockQty")] Products products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int ProId, [Bind("ProId,ProdName,Category,UnitPrice,StockQty")] Products products)
        {
